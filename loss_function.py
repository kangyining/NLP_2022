...
# https://github.com/ThilinaRajapakse/simpletransformers/blob/master/simpletransformers/losses/dice_loss.py
# based on:
...
# https://github.com/ThilinaRajapakse/simpletransformers/blob/master/simpletransformers/losses/focal_loss.py
# based on:
